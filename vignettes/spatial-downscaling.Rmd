...
The `unet` function in the `ECoST` package implements this architecture, allowing the user to modify various hyperparameters such as the number of filters, kernel sizes, dropout rates, and activation functions.
